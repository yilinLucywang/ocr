...
def parse_args():
    ...
    parser.add_argument("--det_model_dir", type=str,default="../../model/ch_ppocr_server_v1.1_det_infer")
    ...
    parser.add_argument("--rec_model_dir", type=str,default="../../model/ch_ppocr_server_v1.1_rec_infer")
    ...
    parser.add_argument(
        "--vis_font_path", type=str, default="../../lib/simfang.ttf")
